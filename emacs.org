...
- [[#general-config][General Config]]
  ...
  - [[#column-number-in-modeline][Column number in modeline]]
  - [[#日本語フォント][日本語フォント]]
- [[#ui][UI]]
  - [[#theme][Theme]]
  - [[#font][Font]]
...
- [[#org][Org]]
  - [[#setup][Setup]]
  - [[#roam][Roam]]
  - [[#subdirectory-namespacing][Subdirectory Namespacing]]
  - [[#keybinds-1][Keybinds]]
  - [[#additions][Additions]]
- [[#ide][IDE]]
  - [[#company][Company]]
...
** Email
#+BEGIN_SRC emacs-lisp
  (setq user-mail-address "noah@nevans.me")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun ne/persp-switch-to-project (&optional default-action)
    "Switch project.
    ...
    (ivy-read (projectile-prepend-project-name "Switch to project: ")
              ...
              :action (lambda (project-path)
                        ...
                        (let* ((persp-name
                                (car (last (split-string project-path "/" t))))
                               (exists (gethash persp-name (perspectives-hash))))
  ...
  (general-define-key :states '(normal insert) :keymaps 'persp-mode-map
                      "C-x x p" #'ne/persp-switch-to-project)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Is this neccesarry? Can I limit it to org-roam
...
Read relative paths in capture template.
#+BEGIN_SRC emacs-lisp
  ;; (setq org-roam-capture-templates
  ;;   `(("d" "default" plain (function org-roam-capture--get-point)
  ;;      "%?"
  ;;      :file-name "%(file-name-directory \"${title}\")%<%Y%m%d%H%M%S>-%(file-name-nondirectory \"${title}\")"
  ;;      :head "#+title: %(file-name-nondirectory \"${title}\")\n"
  ;;      :unnarrowed t)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (with-eval-after-load 'geiser-guile
    ...
    (add-to-list 'geiser-guile-load-path "~/.guix-profile/share/guile/site/2.2/")
    (add-to-list 'geiser-guile-load-path "~/.guix-profile/share/guile/2.2/")
    (add-to-list 'geiser-guile-load-path "~/.guix-extra-profiles/guile/guile/share/guile/site/3.0/")
    (add-to-list 'geiser-guile-load-path "~/.guix-extra-profiles/guile/guile/share/guile/site/2.2/")
    (add-to-list 'geiser-guile-load-path "~/.guix-extra-profiles/guile/guile/share/guile/2.2/")
    (add-to-list 'geiser-guile-load-path "~/builds/guix")
    (add-to-list 'geiser-guile-load-path "~/projects/guile/g-golf"))
...
**** guile
  (require 'geiser)
  (defun eros-geiser-eval-last-sexp (eval-last-sexp-arg-internal)
    (interactive "P")
    (eros--eval-overlay
     (substring (geiser-eval-last-sexp nil)
                3)
     (point)))
  
  (defun eros-geiser-eval-definition (&optional geiser-eval-definition-internal)
    (interactive "P")
    (let ((value (alist-get 'result
                            (geiser-eval-definition geiser-eval-definition-internal)))
  ...
  (define-minor-mode eros-geiser-mode
    "Display Emacs Lisp evaluation results overlays."
    :global t
    (if eros-geiser-mode
        (progn
          (global-set-key [remap geiser-eval-last-sexp] #'eros-geiser-eval-last-sexp)
          (global-set-key [remap geiser-eval-definition] #'eros-geiser-eval-definition))
...
#+BEGIN_SRC emacs-lisp
    (general-define-key :keymaps 'Info-mode-map "e" nil "i" nil
                        "/" #'isearch-forward ;; Evil search is crashing my emacs
                        "?" #'isearch-backward ;; Evil search is crashing my emacs
)
#+END_SRC

load path
#+BEGIN_SRC emacs-lisp
  (add-to-list 'Info-directory-list "/home/clone/.guix-profile/share/info")
  (add-to-list 'Info-directory-list "/home/clone/.guix-extra-profiles/emacs/emacs/share/info")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (require 'imenu-list)
  (csetq imenu-list-position 'left)
#+END_SRC
** Mail
*Guix Packages*
#+BEGIN_SRC lisp :noweb-ref packages
